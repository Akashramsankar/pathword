...
const helpSlidesData = [
  {
    id: 'welcome',
    imageUrl: '/images/help/pathword-grid-welcome.png',
  ...
  {
    id: 'tries-limit',
    imageUrl: '/images/help/pathword-tries-limit.png', // You'll need to create this image
  ...
  // For "HUMBLE"
{
  ...
  // For "UTOPIA"
{
  date: "2025-08-29", // Set your desired date
  grid: [
    ["A", "G", "U", "T", "S", "O"], 
    ["H", "M", "B", "R", "N", "T"],  
    ["E", "O", "C", "M", "V", "L"],  
  ...
  // For "THIRST"
{
  date: "2025-08-28", // Set your desired date
  grid: [
    ["D", "C", "T", "S", "P", "A"],  
    ["R", "O", "N", "U", "W", "H"],  
    ["A", "I", "C", "R", "O", "L"],  
  ...
  // For "EVOLVE"
{
  date: "2025-08-27", // Set your desired date
  grid: [
    ["O", "I", "E", "T", "S", "Y"],  
    ["M", "N", "H", "U", "R", "V"],  
    ["A", "O", "C", "R", "U", "T"], 
  ...
  {
  date: "2025-08-26", // Set your desired date
  grid: [
    ["A", "C", "S", "R", "P", "Y"],  
    ["O", "H", "C", "N", "T", "I"],  
    ["M", "N", "E", "R", "L", "W"],  
  ...
  // For "ANYWAY"
{
  date: "2025-08-25", // Set your desired date
  grid: [
    ["D", "G", "A", "S", "U", "M"], 
    ["C", "I", "P", "U", "R", "N"],  
    ["T", "Y", "E", "C", "U", "I"], 
  ...
  // For "RIDDLE"
{
  date: "2025-08-24", // Set your desired date
  grid: [
    ["B", "F", "R", "L", "S", "W"],  
    ["A", "H", "Y", "U", "O", "I"], 
    ["P", "D", "C", "N", "S", "T"], 
  ...
  // For "MASTER"
{
  date: "2025-08-23", // Set your desired date
  grid: [
    ["D", "G", "M", "P", "S", "W"],  
    ["I", "Y", "U", "H", "O", "A"],  
    ["O", "S", "L", "I", "R", "U"], 
  ...
  // For "ICONIC"
{
  date: "2025-08-22", // Set your desired date
  grid: [
    ["A", "D", "I", "G", "T", "Q"],
    ["N", "S", "O", "U", "M", "C"],  
    ["K", "O", "N", "R", "E", "Z"],  
  ...
  // For "UPDATE"
{
  date: "2025-08-21", // Set your desired date
  grid: [
    ["C", "F", "U", "K", "S", "W"],  
    ["A", "H", "O", "R", "N", "P"],  
    ["I", "D", "W", "S", "T", "V"],  
  ...
  // For "WITHIN"
{
  ...
  // For "TAILOR"
{
  date: "2025-08-11", // Set your desired date
  grid: [
    ["C", "H", "T", "L", "R", "U"], 
    ["R", "H", "N", "O", "I", "A"], 
    ["O", "I", "E", "R", "U", "L"],  
  ...
  // For "MYSELF"
{
  date: "2025-08-10", // Set your desired date
  grid: [
    ["C", "G", "M", "Q", "S", "W"],  
    ["U", "H", "R", "A", "O", "Y"],  
    ["P", "S", "I", "O", "T", "C"],  
  ...
  // For "CUSTOM"
{
  date: "2025-08-09", // Set your desired date
  grid: [
    ["A", "F", "C", "M", "S", "Y"],  
    ["O", "H", "P", "R", "E", "U"],  
    ["R", "S", "I", "N", "V", "T"],  
  ...
  // For "JABBER"
{
  date: "2025-08-08", // Set your desired date
  grid: [
    ["B", "C", "G", "J", "P", "Z"],  
    ["A", "E", "H", "M", "O", "U"], 
    ["E", "F", "I", "L", "B", "C"],  
  ...
  // For "BROKEN"
{
  ...
  // For "PLAYER"
{
  date: "2025-08-06", // Set your desired date
  grid: [
    ["D", "G", "P", "M", "Z", "S"],  
    ["R", "H", "N", "U", "A", "L"],  
    ["Y", "A", "R", "I", "U", "C"],
  ...
  // For "BOWLED"
{
  date: "2025-08-05", // Set your desired date
  grid: [
    ["A", "F", "B", "H", "L", "P"], 
    ["L", "R", "N", "C", "U", "O"],
    ["I", "W", "M", "R", "U", "G"], 
  ...
  // For "BRUTAL"
{
  date: "2025-08-04", // Set your desired date
  grid: [
    ["C", "B", "H", "P", "S", "Z"],  
    ["E", "M", "O", "Y", "R", "U"], 
    ["U", "D", "I", "A", "V", "Y"], 
  ...
  // For "STUDIO"
{
  date: "2025-08-03", // Set your desired date
  grid: [
    ["E", "B", "S", "F", "L", "R"], 
    ["O", "H", "N", "A", "T", "M"], 
    ["U", "I", "C", "R", "V", "A"], 
  ...
  // For "SAFETY"
{
  date: "2025-08-02", // Set your desired date
  grid: [
    ["O", "G", "L", "S", "T", "V"],  
    ["A", "C", "M", "O", "R", "K"],
    ["C", "I", "N", "U", "F", "V"],  
  ...
  // For "BANNER"
{
  date: "2025-08-01", // Set your desired date
  grid: [
    ["F", "B", "H", "K", "Q", "T"],  
    ["R", "U", "L", "O", "A", "Y"],  
    ["N", "D", "I", "R", "U", "V"], 
  ...
  // For "FLOWER"
{
  date: "2025-07-31", // Set your desired date
  grid: [
    ["A", "F", "G", "P", "S", "Z"],  
    ["R", "T", "O", "Y", "L", "U"], 
    ["O", "C", "I", "A", "U", "Y"],  
  ...
  // For "RATION"
{
  date: "2025-07-30", // Set your desired date
  grid: [
    ["B", "G", "R", "H", "T", "U"],  
    ["O", "N", "M", "I", "A", "E"], 
    ["T", "I", "C", "N", "V", "D"],  
  ...
  // For "ATTEND"
{
  date: "2025-07-29", // Set your desired date
  grid: [
    ["C", "J", "A", "M", "R", "Z"],  
    ["E", "R", "M", "L", "T", "S"],  
    ["T", "L", "I", "R", "U", "O"],  
  ...
  // For "FAMILY" 
{
  ...
  // For "HAMMER"
{
  date: "2025-07-26", // Set your desired date
  grid: [
    ["L", "F", "H", "B", "R", "T"], 
    ["O", "I", "N", "Y", "A", "U"], 
    ["M", "C", "J", "I", "U", "R"],  
...
// For "BASKET"
{
  date: "2025-07-25", // Set your desired date
  grid: [
    ["E", "B", "H", "K", "P", "T"],  
    ["R", "M", "U", "E", "A", "L"], 
    ["S", "D", "I", "N", "U", "V"],  
  ...
  // For "LETTER"
{
  date: "2025-07-24", // Set your desired date
  grid: [
    ["A", "R", "L", "P", "T", "V"],  
    ["O", "I", "M", "Y", "E", "U"],  
    ["T", "C", "I", "N", "U", "V"],  
  ...
  // For "LYRICS"
{
  date: "2025-07-23", // Set your desired date
  grid: [
    ["E", "G", "L", "P", "S", "Y"],  
    ["A", "O", "M", "T", "Y", "U"], 
    ["R", "I", "D", "N", "U", "B"],  
  ...
  // For "FRIEND"
{
  date: "2025-07-22", // Set your desired date
  grid: [
    ["C", "F", "I", "M", "R", "W"],  
    ["A", "H", "O", "T", "R", "L"],  
    ["I", "C", "E", "N", "U", "A"], 
...
// For "MIGHTY"
{
  date: "2025-07-21", // Set your desired date
  grid: [
    ["D", "F", "M", "J", "R", "V"],  
    ["A", "E", "P", "Y", "I", "U"],  
    ["G", "C", "J", "N", "U", "R"],  
...
// For "POTENT"
{
  date: "2025-07-20", // Set your desired date
  grid: [
    ["Q", "F", "P", "R", "S", "W"],  
    ["A", "U", "M", "R", "O", "L"],  
    ["T", "C", "I", "N", "L", "U"], 
  ...
  // For "EUREKA"
{
  ...
  // For "PURSUE"
{
  date: "2025-07-17", // Set your desired date
  grid: [
    ["H", "W", "P", "K", "S", "V"], 
    ["A", "E", "M", "H", "U", "R"],  
    ["R", "C", "O", "N", "L", "I"],  
  ...
  // For "WICKET"
{
  ...
  // For "BEAUTY"
{
  date: "2025-07-13", // Set your desired date
  grid: [
    ["D", "B", "F", "H", "J", "L"],  
    ["A", "G", "O", "R", "E", "U"],  
    ["A", "D", "I", "N", "U", "L"],  
  ...
  // For "BELIEF"
{
  date: "2025-07-12", // Set your desired date
  grid: [
    ["D", "B", "F", "H", "J", "L"],  
    ["A", "G", "O", "R", "E", "U"],  
    ["L", "D", "I", "N", "U", "S"],  
  ...
  // For "LINKED"
{
  ...
  // For "RESULT"
{
  date: "2025-07-09", // Set your desired date
  grid: [
    ["C", "F", "R", "L", "P", "Y"],  
    ["A", "H", "M", "U", "E", "O"],  
    ["S", "C", "I", "N", "U", "T"], 
  ...
  // For "CINEMA"
{
  date: "2025-07-08", // Set your desired date
  grid: [
    ["B", "G", "C", "K", "S", "U"],  
    ["A", "H", "T", "N", "I", "L"],  
    ["N", "A", "J", "P", "U", "R"],  
  ...
  // For "REVEAL"
{
  ...
  // For "ACCESS"
{
  date: "2025-07-05", // Set your desired date
  grid: [
    ["C", "K", "A", "P", "V", "G"],  
    ["E", "N", "M", "R", "C", "T"],  
    ["C", "I", "J", "T", "U", "R"], 
  ...
  // For "VOLLEY"
{
  date: "2025-07-04", // Set your desired date
  grid: [
    ["D", "H", "V", "R", "M", "U"],  
    ["A", "E", "M", "N", "O", "Y"],  
    ["L", "C", "I", "N", "R", "A"],  
  ...
  // For "GENOME"
{
  ...
  // For "FOREST"
{
  date: "2025-06-29", // Set your desired date
  grid: [
    ["B", "F", "G", "L", "S", "Y"], 
    ["A", "H", "L", "R", "O", "U"],  
    ["R", "C", "I", "N", "U", "X"],  
  ...
  // For "ARTIST"
{
  date: "2025-06-28", // Set your desired date
  grid: [
    ["B", "C", "A", "L", "M", "N"],  
    ["C", "H", "M", "Q", "R", "T"],  
    ["T", "D", "I", "N", "U", "O"], 
  ...
  // For "SPIRIT"
{
  ...
  // For "MENTOR"
{
  date: "2025-06-24", // Set your desired date
  grid: [
    ["C", "I", "M", "D", "S", "Y"],  
    ["A", "H", "P", "O", "Y", "E"],  
    ["L", "N", "I", "T", "U", "Z"],  
  ...
  // For "RESORT"
{
  date: "2025-06-23", // Set your desired date
  grid: [
    ["B", "G", "R", "L", "P", "C"], 
    ["A", "H", "M", "O", "U", "E"], 
    ["S", "I", "C", "N", "U", "Z"],  
  ...
  // For "CANCEL"
{
  date: "2025-06-22", // Set your desired date
  grid: [
    ["A", "G", "C", "M", "P", "Y"],  
    ["E", "H", "M", "S", "U", "A"],  
    ["E", "N", "I", "T", "U", "Z"],  
